...
describe("1 SOL Buy Test", () => {
  ...
  before(async () => {
    ...
    // Transfer 1.1 SOL to test buyer (1 SOL for buying + 0.1 for fees)
  ...
  describe("Buy with 1 SOL", () => {
    it("Should buy tokens with 1 SOL", async () => {
      console.log("\n========== BUY WITH 1 SOL ==========");
      ...
      try {
        ...
        const tokensReceived = Number(buyerTokenAccountInfo.amount) / 1e9;
        const solSpent = (initialSol - finalSol) / LAMPORTS_PER_SOL;
        const actualPrice = solSpent / tokensReceived;
        console.log("\nTrade Summary:");
        console.log("  Actual price paid:", actualPrice.toFixed(8), "SOL per token");
        console.log("  Tokens per SOL:", (tokensReceived / solSpent).toFixed(4));
  ...
  describe("Final State", () => {
    it("Should display final state", async () => {
      ...
      try {
        ...
        console.log("\n=====================================");
        console.log("1 SOL BUY TEST COMPLETED");
        console.log("=====================================");
